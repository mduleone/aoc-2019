...
def compute_move_coords(starting_point, instruction)
...
def compute_set_of_points(wire_directions)
  ...
  for direction in wire_directions do
    result = compute_move_coords(current_point, direction)
...
def compute_manhattan_distance_from_center(point)
...
intersection = wire_1_points.intersection wire_2_points

distances = intersection.delete([0, 0]).map { |point| compute_manhattan_distance_from_center point }
